...
async function registerSlashCommands(client) {
  ...
  const commands = [
    ...
    {
      name: 'broadcast',
      description: 'Admins: Manage audio broadcasting system.',
      default_member_permissions: ADMIN,
      options: [
        {
          type: 1, // SUB_COMMAND
          name: 'setup',
          description: 'Configure a broadcast session'
        },
        {
          type: 1,
          name: 'start',
          description: 'Start broadcasting from source to target channels',
          options: [
            {
              type: 3, // STRING
              name: 'config',
              description: 'Saved configuration name (optional)',
              required: false
            }
          ]
        },
        {
          type: 1,
          name: 'stop',
          description: 'Stop active broadcast'
        },
        {
          type: 1,
          name: 'addchannel',
          description: 'Add a target channel to broadcast',
          options: [
            {
              type: 7, // CHANNEL
              name: 'channel',
        ...
        },
        {
          type: 1,
          name: 'removechannel',
          description: 'Remove a target channel',
          options: [
            {
              type: 7,
              name: 'channel',
        ...
        },
        {
          type: 1,
          name: 'status',
          description: 'View current broadcast status'
        },
        {
          type: 1,
          name: 'volume',
          description: 'Adjust broadcast volume',
          options: [
            {
              type: 4, // INTEGER
              name: 'level',
